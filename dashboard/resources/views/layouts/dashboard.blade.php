...
<div class="layout">
    ...
    <a href="{{ route('integrations.telegram.edit') }}" class="sidebar-link {{ request()->routeIs('integrations.telegram.*') ? 'active' : '' }}">
      <svg viewBox="0 0 24 24"><path d="M21.5 2.5 2.8 9.8c-1.3.5-1.3 2.3 0 2.8l4.6 1.7 1.7 4.6c.5 1.3 2.3 1.3 2.8 0l7.3-18.7c.4-1.1-.7-2.2-1.8-1.8Z"/><path d="m7.4 14.6 4.1-4.1"/></svg>
      Telegram Alerts
    </a>
  </aside>
